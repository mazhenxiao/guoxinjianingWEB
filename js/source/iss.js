...
(function ($, window) {
    ...
    var doc = document,
        ...
        tableArg,
        ISS_SROUCE_URL = "js/source/";  //页面引入js资源地址配置，可更换
    ...
    var iss = {
        ...
        tabs: function () {
            ...
            tabs.each(function (i, e) {
                ...
                for (; i < _e.length; i++) {
                    if (_e[i].nodeType === 1) {
                        ...
                        _t += '<li class="iss_tabs_li' + i + linum + '">' + ti + '</li>';
                        linum = "";
                    }
                }
                de && (ele.className += " on");
            ...
            $(".iss-tabs").off("click.iss").on("click.iss", ".iss-tabs-nav li", function () {
                ...
                th.addClass("on");
                var eles = pa.find(".iss_tabls_child:eq(" + ind + ")").addClass("on");
                setTimeout(function () {
                    self.gruid(eles);
                });
            });
        ...
        setTime: function (obj) {
            ...
            var setT = setInterval(function () {
                ...
                $(obj.day).html((_d <= 0) ? 0 : _d);
                $(obj.hour).html((_h <= 0) ? 0 : _h);
                $(obj.minute).html((_m <= 0) ? 0 : _m);
                $(obj.second).html((_s <= 0) ? 0 : _s);
            }, 1000);
